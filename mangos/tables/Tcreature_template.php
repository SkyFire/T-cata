<?php
    ...
    {
        updateRecords($_POST,$result,SQL_WORLD_DATABASE,"creature_template","entry",$_REQUEST['npc'],"");
        $result = creature($_REQUEST['npc']);
    }
    ...
    <legend>Creature I</legend>
            ...
            <table>
                <tr>
                    ...
                    <td >minhealth<br><input type="text" name="minhealth" value="<?php echo $result['minhealth'];?>"></td>
                    <td >maxhealth<br><input type="text" name="maxhealth" value="<?php echo $result['maxhealth'];?>"></td>
                    <td >minmana<br><input type="text" name="minmana" value="<?php echo $result['minmana'];?>"></td>
                    <td >maxmana<br><input type="text" name="maxmana" value="<?php echo $result['maxmana'];?>"></td>
                </tr>
            </table>
    </fieldset>
<br/>
        ...
        <table class="resultsborder">
            <tr>
                    ...
                    <td >rangedattackpower<br><input type="text" name="rangedattackpower" value="<?php echo $result['rangedattackpower'];?>"></td>
                     ...
                     <td >RegenHealth<br><input type="text" name="RegenHealth" value="<?php echo $result['RegenHealth'];?>"></td>
    ...
    <tr>
                ...
                <legend>Spells</legend>
                    ...
                    <?php for($i=1;$i<=2;$i++){
                        echo '
                            ...
                            <td class="tablefont" >spell'.($i+2).'<br><input class="cinputbox"  type="text" name="spell'.($i+2).'" value="'.$result['spell'.($i+2)].'"></td>
                            </tr><tr>';
                    }?>
                </tr></table>
            </fieldset>
        ...
        <td valign="top"><!-- armor /unk -->
            <fieldset>
                <legend>Armor</legend>
                    <table class="resultsborder"><tr>
                    <td class="tablefont"  colspan="2">armor<br><input class="cinputbox"  type="text" name="armor" value="<?php echo $result['armor'];?>"></td></tr><tr>
...
<p/> <div align="right"><input class="inputbtn" type="submit" name="submit" value="Save"></div>           
