...
<form method="post">
<table>
    <tr><td><b class="inputlabel">QuestId: </b></td><td><input type="text" name="questID"></td>
    <td><b class="inputlabel">Quest Title:</b></td><td><input type="text" name="questTitle"></td></tr>
    <tr><td><b class="inputlabel">Quest Giver:</b></td><td><input type="text" name="questGiver"></td>
    <td><b class="inputlabel">Quest Taker:</b></td><td><input type="text" name="questTaker"></td></tr>
    <tr><td><b class="inputlabel">prevQuestId:</b></td><td><input type="text" name="prevQuestID"></td>
    <td><b class="inputlabel">nextQuestId:</b></td><td><input type="text" name="nextQuestID"></td></tr>
